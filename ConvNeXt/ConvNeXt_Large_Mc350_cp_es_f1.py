...
for epoch in range(NUM_EPOCH):
    ...
    for train_batch in tqdm(train_dataloader_mask):
        ...
        if epoch % 10 == 0:
            torch.save(basemodel_convnext_l, '../checkpoint/basemodel_convnext_l-3/checkpoint_ep_%d.pth'% epoch)
...
#             cur_count = 0
            torch.save(basemodel_convnext_l, '../checkpoint/basemodel_convnext_l-3/checkpoint_best.pth')
#         else:
#             cur_count += 1
...
basemodel_convnext_l = torch.load('../checkpoint/basemodel_convnext_l-3/checkpoint_best.pth')
